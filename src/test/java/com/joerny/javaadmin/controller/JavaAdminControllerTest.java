...
public class JavaAdminControllerTest {
    ...
    public void list() throws Exception {
        ...
        basicEntity.setNotNullField("NotNullFieldListTest");
        ...
        Assert.assertEquals(9, testEntity.size());
    ...
    public void createSimplePost() throws Exception {
        ...
        request.param(BasicEntity.class.getSimpleName() + ".notNullField", "NotNullField");
